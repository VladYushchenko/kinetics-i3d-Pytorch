...
if __name__ == '__main__':
    ...
    if args.target_dir is None:
        if not os.path.exists("../data/pytorch_checkpoints/"):
    ...
    load_conv3d(state_dict, modality, dump_dir, name_pth='features_block.0', name_tf='Conv3d_1a_7x7')
    load_conv3d(state_dict, modality, dump_dir, name_pth='features_block.2', name_tf='Conv3d_2b_1x1')
    load_conv3d(state_dict, modality, dump_dir, name_pth='features_block.3', name_tf='Conv3d_2c_3x3')

    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.5', name_tf='Mixed_3b')
    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.6', name_tf='Mixed_3c')
    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.8', name_tf='Mixed_4b')
    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.9', name_tf='Mixed_4c')
    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.10', name_tf='Mixed_4d')
    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.11', name_tf='Mixed_4e')
    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.12', name_tf='Mixed_4f')
    load_Mixed_5b(state_dict, modality, dump_dir, name_pth='features_block.14', name_tf='Mixed_5b')
    load_Mixed(state_dict, modality, dump_dir, name_pth='features_block.15', name_tf='Mixed_5c')
    load_Logits(state_dict, modality, dump_dir, name_pth='logits_block.1', name_tf='Logits/Conv3d_0c_1x1')
